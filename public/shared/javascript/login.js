...
function CLoginPromptManager( strBaseURL, rgOptions )
{
	...
	if ( typeof BigNumber == 'undefined' )
		$J.ajax( { url: '/public/shared/javascript/crypto/jsbn.js', type: 'get', dataType: 'script', cache: true } );
	if ( typeof RSA == 'undefined' )
		$J.ajax( { url: '/public/shared/javascript/crypto/rsa.js', type: 'get', dataType: 'script', cache: true } );
}
